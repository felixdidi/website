...
\item \textit{Advisor}: Prof. Dr. Leonard Reinecke
\end{cvitems}}
    \cventry{Teaching Associate at the Institute for Media and Communication Studies}{University of Mannheim}{02/22 - 07/24}{}{\begin{cvitems}
...
\phantomsection\label{refs-365d51d03b11fb701183a4999e6e9a62}
\begin{CSLReferences}{1}{0}
\bibitem[\citeproctext]{ref-gilbertTooAmusedStop2024}
...
\begin{cventries}
    \cventry{Johannes Gutenberg University Mainz}{Content Analysis: Content of Public Communication}{10/24 - 03/25}{}{\begin{cvitems}
\item Seminar in the module ``Political Communication'' for the BA Communication Science program
\end{cvitems}}
    \cventry{Johannes Gutenberg University Mainz}{The Algorithm Knows Me (Not): Media Entertainment in Algorithmically Curated Environments}{04/24 - 09/24}{}{\begin{cvitems}
